...
export const nutritionFoodDatabase = [
  ...
  { id: "food_hard_cheese", name: "Cheese, cheddar (Includes foods for USDA's Food Distribution Program)", displayName: "Сыр твёрдый", aliases: ["сыр", "твердый сыр", "чеддер"], portion: "100 г", calories: 403, protein: 22.9, fat: 33.3, carbs: 3.37, recordType: "reference_food", source: USDA_SOURCE, sourceUrl: fdcUrl("173414") },
