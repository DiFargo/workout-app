...
export default function HistoryDeleteConfirmDialog({
  ...
  return (
    <div className={styles.overlay} data-modal-backdrop="true" data-testid="workout-history-delete-overlay" data-css-module-scope="workout-history-delete" onClick={onClose}>
