...
- main CSS bundle: about `1131.56 KiB` raw, `114.28 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3308.48 KiB` total source CSS.
