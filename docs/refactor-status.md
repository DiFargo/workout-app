...
Last updated at app version `v.1.476`.
...
- main CSS bundle: about `1156.24 KiB` raw, `115.72 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3442.99 KiB` total source CSS.
...
- `npm.cmd run test`: passed with `305` passed.
