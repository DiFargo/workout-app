...
- main CSS bundle: about `1171.69 KiB` raw, `116.76 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3461.66 KiB` total source CSS.
