...
- main CSS bundle: about `1155.78 KiB` raw, `115.67 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3442.44 KiB` total source CSS.
