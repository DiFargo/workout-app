...
- main CSS bundle: about `1127.97 KiB` raw, `114.16 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3298.23 KiB` total source CSS.
