...
- main CSS bundle: about `1128.09 KiB` raw, `114.16 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3298.49 KiB` total source CSS.
...
- `npm.cmd run test`: passed with `317` passed.
