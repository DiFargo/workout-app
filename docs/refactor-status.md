...
- main CSS bundle: about `1145.61 KiB` raw, `114.95 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3390.55 KiB` total source CSS.
