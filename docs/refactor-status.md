...
- main CSS bundle: about `1122.63 KiB` raw, `113.90 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3281.47 KiB` total source CSS.
...
- `npm.cmd run test`: passed with `405` passed.
