...
Last updated at app version `v.1.477`.
...
- main CSS bundle: about `1156.01 KiB` raw, `115.71 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3442.71 KiB` total source CSS.
