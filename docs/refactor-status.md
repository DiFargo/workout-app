...
Last updated at app version `v.1.443`.
...
- main CSS bundle: about `1179.80 KiB` raw, `117.21 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3471.19 KiB` total source CSS.
...
- `npm.cmd run test`: passed, `288` passed.
