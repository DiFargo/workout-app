...
- main CSS bundle: about `1184.75 KiB` raw, `117.42 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3476.80 KiB` total source CSS.
...
- `npm.cmd run test`: passed, `282` passed.
