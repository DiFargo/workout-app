...
- main CSS bundle: about `1145.08 KiB` raw, `114.92 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3389.93 KiB` total source CSS.
