...
Last updated at app version `v.1.466`.
...
- main CSS bundle: about `1164.37 KiB` raw, `116.15 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3453.07 KiB` total source CSS.
...
- `npm.cmd run test`: passed with `303` passed.
