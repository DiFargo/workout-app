...
- main CSS bundle: about `1128.28 KiB` raw, `114.17 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3298.83 KiB` total source CSS.
