...
- main CSS bundle: about `1156.49 KiB` raw, `115.73 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3443.27 KiB` total source CSS.
