...
- main CSS bundle: about `1155.02 KiB` raw, `115.61 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3441.30 KiB` total source CSS.
