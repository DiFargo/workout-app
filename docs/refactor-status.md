...
Last updated at app version `v.1.453`.
...
- main CSS bundle: about `1172.22 KiB` raw, `116.79 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3462.31 KiB` total source CSS.
...
- `npm.cmd run test`: passed with `296` passed.
