...
- main CSS bundle: about `1181.41 KiB` raw, `117.28 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3472.98 KiB` total source CSS.
...
- `npm.cmd run test`: passed, `286` passed.
