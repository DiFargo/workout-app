...
Last updated at app version `v.1.438`.
...
- main CSS bundle: about `1183.87 KiB` raw, `117.38 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3475.79 KiB` total source CSS.
...
- `npm.cmd run test`: passed, `283` passed.
