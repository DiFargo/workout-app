...
- main CSS bundle: about `1144.91 KiB` raw, `114.89 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3389.73 KiB` total source CSS.
