...
- main CSS bundle: about `1178.26 KiB` raw, `117.10 KiB` gzip.
- CSS budget: `2100 KiB` raw, `270 KiB` gzip.
- CSS source files under `src`: 100 total in the latest `npm.cmd run report:css` pass, about `3469.41 KiB` total source CSS.
...
- `npm.cmd run test`: passed, `290` passed.
