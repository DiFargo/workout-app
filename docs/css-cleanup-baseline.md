...
- Latest main CSS bundle: about `1174.25 KiB` raw, `116.91 KiB` gzip.
- Latest source CSS report: `100` files, about `3464.72 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `244.46 KiB`
