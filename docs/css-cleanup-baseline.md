...
- Latest main CSS bundle: about `1178.72 KiB` raw, `117.18 KiB` gzip.
- Latest source CSS report: `100` files, about `3469.98 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `249.72 KiB`
