...
- Latest main CSS bundle: about `1172.84 KiB` raw, `116.84 KiB` gzip.
- Latest source CSS report: `100` files, about `3463.03 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `242.76 KiB`
