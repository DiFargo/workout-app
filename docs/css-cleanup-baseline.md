...
- Latest main CSS bundle: about `1130.53 KiB` raw, `114.25 KiB` gzip.
- Latest source CSS report: `100` files, about `3307.16 KiB` total source CSS.
...
- `src/styles/legacy-profile-dashboard-telegram-late.css` - `82.78 KiB`
