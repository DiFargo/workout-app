...
- Latest main CSS bundle: about `1127.97 KiB` raw, `114.16 KiB` gzip.
- Latest source CSS report: `100` files, about `3298.23 KiB` total source CSS.
...
- `src/styles/legacy-desktop-cabinet-polish.css` - `90.18 KiB`
