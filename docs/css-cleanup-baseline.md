...
- Latest main CSS bundle: about `1164.37 KiB` raw, `116.15 KiB` gzip.
- Latest source CSS report: `100` files, about `3453.07 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `232.81 KiB`
