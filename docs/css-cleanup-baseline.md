...
- Latest main CSS bundle: about `1130.50 KiB` raw, `114.27 KiB` gzip.
- Latest source CSS report: `100` files, about `3307.08 KiB` total source CSS.
...
- `src/styles/legacy-profile-dashboard-telegram-late.css` - `82.70 KiB`
