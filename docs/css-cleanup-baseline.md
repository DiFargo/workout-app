...
- `v.1.786`: kept the client harness main header on shared chrome sizing, replaced date emoji with SVG icons, restored the segmented progress gauge and fixed the measurement tooltip fill.
