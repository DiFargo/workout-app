...
- Latest main CSS bundle: about `1186.36 KiB` raw, `117.49 KiB` gzip.
- Latest source CSS report: `100` files, about `3478.73 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `258.47 KiB`
