...
- Latest main CSS bundle: about `1184.75 KiB` raw, `117.42 KiB` gzip.
- Latest source CSS report: `100` files, about `3476.80 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `256.54 KiB`
