...
- Latest main CSS bundle: about `1127.34 KiB` raw, `114.13 KiB` gzip.
- Latest source CSS report: `100` files, about `3295.58 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `209.91 KiB`
...
1. Client primary screens.
   ...
   - Continued in `v.1.650`: grouped food search create-action inactive/active color CSS in `client-primary-final-lock.css`.
