...
- Latest main CSS bundle: about `1179.80 KiB` raw, `117.21 KiB` gzip.
- Latest source CSS report: `100` files, about `3471.19 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `250.93 KiB`
