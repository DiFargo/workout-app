...
- Latest main CSS bundle: about `1164.09 KiB` raw, `116.12 KiB` gzip.
- Latest source CSS report: `100` files, about `3452.73 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `232.47 KiB`
