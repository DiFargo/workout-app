...
- Latest main CSS bundle: about `1155.18 KiB` raw, `115.62 KiB` gzip.
- Latest source CSS report: `100` files, about `3441.49 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `221.22 KiB`
