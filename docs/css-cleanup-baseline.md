...
- Latest main CSS bundle: about `1173.35 KiB` raw, `116.88 KiB` gzip.
- Latest source CSS report: `100` files, about `3463.65 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `243.38 KiB`
