...
- Latest main CSS bundle: about `1165.83 KiB` raw, `116.35 KiB` gzip.
- Latest source CSS report: `100` files, about `3454.78 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `234.51 KiB`
