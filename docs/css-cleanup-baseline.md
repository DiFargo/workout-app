...
- Latest main CSS bundle: about `1158.70 KiB` raw, `115.87 KiB` gzip.
- Latest source CSS report: `100` files, about `3446.12 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `225.85 KiB`
