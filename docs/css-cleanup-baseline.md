...
- Latest main CSS bundle: about `1165.40 KiB` raw, `116.31 KiB` gzip.
- Latest source CSS report: `100` files, about `3454.27 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `234.00 KiB`
