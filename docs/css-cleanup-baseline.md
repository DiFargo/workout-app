...
- Latest main CSS bundle: about `1130.49 KiB` raw, `114.28 KiB` gzip.
- Latest source CSS report: `100` files, about `3306.91 KiB` total source CSS.
...
- `src/styles/legacy-profile-dashboard-telegram-late.css` - `82.53 KiB`
