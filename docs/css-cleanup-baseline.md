...
- Latest main CSS bundle: about `1128.23 KiB` raw, `114.17 KiB` gzip.
- Latest source CSS report: `100` files, about `3298.75 KiB` total source CSS.
...
- `src/styles/legacy-desktop-cabinet-polish.css` - `90.70 KiB`
