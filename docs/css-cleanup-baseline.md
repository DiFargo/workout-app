...
- Latest main CSS bundle: about `1156.49 KiB` raw, `115.73 KiB` gzip.
- Latest source CSS report: `100` files, about `3443.27 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `223.00 KiB`
