...
- Latest main CSS bundle: about `1153.41 KiB` raw, `115.47 KiB` gzip.
- Latest source CSS report: `100` files, about `3439.24 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `218.98 KiB`
