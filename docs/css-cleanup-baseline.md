...
- Latest main CSS bundle: about `1155.02 KiB` raw, `115.61 KiB` gzip.
- Latest source CSS report: `100` files, about `3441.30 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `221.04 KiB`
