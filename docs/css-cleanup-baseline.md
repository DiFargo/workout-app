...
- Latest main CSS bundle: about `1128.06 KiB` raw, `114.16 KiB` gzip.
- Latest source CSS report: `100` files, about `3298.42 KiB` total source CSS.
...
- `src/styles/legacy-desktop-cabinet-polish.css` - `90.37 KiB`
