...
- Latest main CSS bundle: about `1166.46 KiB` raw, `116.39 KiB` gzip.
- Latest source CSS report: `100` files, about `3455.52 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `235.25 KiB`
