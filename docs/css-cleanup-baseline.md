...
- Latest main CSS bundle: about `1172.57 KiB` raw, `116.80 KiB` gzip.
- Latest source CSS report: `100` files, about `3462.71 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `242.45 KiB`
