...
- Latest main CSS bundle: about `1166.71 KiB` raw, `116.41 KiB` gzip.
- Latest source CSS report: `100` files, about `3455.81 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `235.55 KiB`
