...
- Latest main CSS bundle: about `1172.22 KiB` raw, `116.79 KiB` gzip.
- Latest source CSS report: `100` files, about `3462.31 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `242.05 KiB`
