...
- Latest main CSS bundle: about `1157.29 KiB` raw, `115.76 KiB` gzip.
- Latest source CSS report: `100` files, about `3444.48 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `224.21 KiB`
