...
- Latest main CSS bundle: about `1127.81 KiB` raw, `114.15 KiB` gzip.
- Latest source CSS report: `100` files, about `3297.88 KiB` total source CSS.
...
- `src/styles/legacy-desktop-cabinet-polish.css` - `89.83 KiB`
