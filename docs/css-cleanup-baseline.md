...
- Latest main CSS bundle: about `1128.16 KiB` raw, `114.16 KiB` gzip.
- Latest source CSS report: `100` files, about `3298.62 KiB` total source CSS.
...
- `src/styles/legacy-desktop-cabinet-polish.css` - `90.57 KiB`
