...
- Latest main CSS bundle: about `1154.36 KiB` raw, `115.56 KiB` gzip.
- Latest source CSS report: `100` files, about `3440.33 KiB` total source CSS.
...
- `src/styles/client-primary-final-lock.css` - `220.07 KiB`
